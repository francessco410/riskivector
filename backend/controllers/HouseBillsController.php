...
use backend\models\HouseBillsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * HouseBillsController implements the CRUD actions for Counter model.
 */
class HouseBillsController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new HouseBillsSearch();
